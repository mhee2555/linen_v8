...
if ($chk == 'one') {
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('A5', 'Report_REPLENISHMENT');
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('B7', 'CUS CODE');
  $objPHPExcel->getActiveSheet()->setCellValue('C7', 'CUS NAME');
  $objPHPExcel->getActiveSheet()->setCellValue('D7', 'ITEM CODE');
  $objPHPExcel->getActiveSheet()->setCellValue('E7', 'ITEM NAME');
  $objPHPExcel->getActiveSheet()->setCellValue('F7', 'PAR QTY');
  $objPHPExcel->getActiveSheet()->setCellValue('G7', 'SHELF COUNT');
  $objPHPExcel->getActiveSheet()->setCellValue('H7', 'ISSUE QTY');
  $objPHPExcel->getActiveSheet()->setCellValue('I7', 'percentreplenishment');
  ...
  // ----------------------------------------------------------------------------------------
    ...
    $query = "SELECT
                ...
                dp.DepCode AS CUSTOMER,
                dp.DepName AS CUSTOMER_NAME,
                report_sc.ItemCode,
                report_sc.ItemName,
                report_sc.ParQty AS PARQTY,
                SUM(report_sc.CcQty) AS SHELFCOUNT,
                SUM(report_sc.TotalQty) AS ISSUE,
                ROUND(((SUM(report_sc.CcQty) + SUM(report_sc.TotalQty))/report_sc.ParQty) * 100 , 2) AS PERCENT
              FROM
                report_sc
    ...
    while ($Result = mysqli_fetch_assoc($meQuery))
    {
      ...
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $Result["CUSTOMER_NAME"]);
      $r++;
      ...
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $Result["SHELFCOUNT"]);
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $Result["ISSUE"]);
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $Result["PERCENT"].'%');
      $r++;
      $start_row ++; 
      $r = 0;

      $totalpar+=$Result["PARQTY"];
      $totalsc+=$Result["SHELFCOUNT"];
      $totalissue+=$Result["ISSUE"];

    }
    $totalpercent = number_format((($totalsc+$totalissue)/$totalpar) *100,2);
    ...
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, '');
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $totalpar);
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $totalsc);
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $totalissue);
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $totalpercent.'%');
    $r++;
    $start_row ++; 
    $r = 0;
    ...
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, '');
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, 'Stock out Replenishment');
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $totalall.'%');
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, '');
    $r++;
    $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, '');
  ...
  $objPHPExcel->getActiveSheet()->getStyle("A7:" . "I" . $start_row)->applyFromArray($fill);
  $objPHPExcel->getActiveSheet()->getStyle("A7:I7")->applyFromArray($A7);
...
$file_name = "Report_REPLENISHMENT_SAP_xls_" . $date . "_" . $h . "_" . $i . "_" . $s . ")";
//
