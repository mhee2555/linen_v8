...
// -----------------------------------------------------------------------------------
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('I7', 'มูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('J6:K6');
  $objPHPExcel->getActiveSheet()->setCellValue('J6', 'New Linens in Month');
  $objPHPExcel->getActiveSheet()->setCellValue('J7', 'จำนวน');
  $objPHPExcel->getActiveSheet()->setCellValue('K7', 'มูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('L6:M6');
  $objPHPExcel->getActiveSheet()->setCellValue('L6', 'Old Bal + New Purchase');
  $objPHPExcel->getActiveSheet()->setCellValue('L7', 'รวมยอด');
  $objPHPExcel->getActiveSheet()->setCellValue('M7', 'รวมมูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('N6:U6');
  $objPHPExcel->getActiveSheet()->setCellValue('N6', 'Linen stock count');
  $objPHPExcel->getActiveSheet()->setCellValue('N7', 'บนวอร์ด');
  $objPHPExcel->getActiveSheet()->setCellValue('O7', 'ห้องคนไข้');
  $objPHPExcel->getActiveSheet()->setCellValue('P7', 'ห้องผ้า');
  $objPHPExcel->getActiveSheet()->setCellValue('Q7', 'ผ้าเปื้อน');
  $objPHPExcel->getActiveSheet()->setCellValue('R7', 'ผ้าสะอาด');
  $objPHPExcel->getActiveSheet()->setCellValue('S7', 'OPD');
  $objPHPExcel->getActiveSheet()->setCellValue('T7', 'ยอดตรวจนับ');
  $objPHPExcel->getActiveSheet()->setCellValue('U7', 'มูลค่าตรวจนับ');

  $objPHPExcel->getActiveSheet()->mergeCells('V6:W6');
  $objPHPExcel->getActiveSheet()->setCellValue('V6', 'Sale to Patient');
  $objPHPExcel->getActiveSheet()->setCellValue('V7', 'ยอดขายผู้ป่วย');
  $objPHPExcel->getActiveSheet()->setCellValue('W7', 'มูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('X6:Y6');
  $objPHPExcel->getActiveSheet()->setCellValue('X6', 'Damage');
  $objPHPExcel->getActiveSheet()->setCellValue('X7', 'ยอดชำรุด');
  $objPHPExcel->getActiveSheet()->setCellValue('Y7', 'มูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('Z6:AA6');
  $objPHPExcel->getActiveSheet()->setCellValue('Z6', 'New Bal + Sale + Damage');
  $objPHPExcel->getActiveSheet()->setCellValue('Z7', 'รวมยอด');
  $objPHPExcel->getActiveSheet()->setCellValue('AA7', 'รวมมูลค่า');
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('AE7', 'รวมยอด');
  $objPHPExcel->getActiveSheet()->setCellValue('AF7', 'รวมมูลค่า');

  $objPHPExcel->getActiveSheet()->mergeCells('AG6:AH6');
  $objPHPExcel->getActiveSheet()->setCellValue('AG6', 'New Stock-เบิกเพิ่มในเดือน');
  $objPHPExcel->getActiveSheet()->setCellValue('AG7', 'รวมยอด');
  $objPHPExcel->getActiveSheet()->setCellValue('AH7', 'รวมมูลค่า');
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('G8', 'รับผ้าเข้าภายในวันที่');
