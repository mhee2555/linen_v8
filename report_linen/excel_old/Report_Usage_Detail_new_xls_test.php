  ...
  $DepName = 'ทุกแผนก';
    ...
    //====================================================================
          ...
          $Select_Dep = "SELECT item.ItemCode,department.DepCode,department.DepName,item.ItemName
                        ...
                        INNER JOIN item ON report_sc.ItemCode = item.ItemCode
          ...
          for ($day = 0; $day < $count; $day++) 
          {
            ...
            for ($xi=0;$xi<$item_cnt;$xi++) 
            {
              ...
              $bROW_ISSUE_SUM   += $ISSUE_loop;
              $bROW_Short_SUM   += $Short_loop;
              $bROW_Over_SUM    += $Over_loop;
              ...
              $rTotal_ISSUE_SUM[$day] += $bROW_ISSUE_SUM;
              $rTotal_Short_SUM[$day] += $bROW_Short_SUM;
              $rTotal_Over_SUM[$day]  += $bROW_Over_SUM;
              //==========================================================
              // if($day == ($count-1))
              // {
              //   if ($bROW_ISSUE_SUM==0) {
              ...
              //     $bROW_Over_SUM="";
              //   }
              //   $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[((($count) *3)+2)] . $start_row, $bROW_ISSUE_SUM);
              //   $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[((($count) *3)+2)+1] . $start_row, $bROW_Short_SUM);
              //   $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[((($count) *3)+2)+2] . $start_row, $bROW_Over_SUM);
              //   $bROW_ISSUE_SUM = 0;
              //   $bROW_Short_SUM = 0;
              //   $bROW_Over_SUM  = 0;
              // }
              ...
              if ($xChk[$xi] == 1) {
                ...
                // $xt3  = 0;
                // for ($day1 = 0; $day1 < $count; $day1++) {
                //     $pROW_ISSUE_SUM[$day1] = 0;
                //     $pROW_Short_SUM[$day1] = 0;
                //     $pROW_Over_SUM[$day1]  = 0;
                // }

                // for ($day1 = 0; $day1 < $count; $day1++) {
                //   $xCol = (($day1*3)+2);
                    
                //     $iROW_ISSUE_SUM   += $rTotal_ISSUE_SUM[$day1];
                //     $iROW_Short_SUM   += $rTotal_Short_SUM[$day1];
                //     $iROW_Over_SUM    += $rTotal_Over_SUM[$day1];

                //     if ($day1 == ($count-1)) {
                //       $pROW_ISSUE_SUM[$day1] = $iROW_ISSUE_SUM;
                //       $pROW_Short_SUM[$day1] = $iROW_Short_SUM;
                //       $pROW_Over_SUM[$day1] = $iROW_Over_SUM;
                //       $iROW_ISSUE_SUM = 0;
                //       $iROW_Short_SUM = 0;
                //       $iROW_Over_SUM  = 0;
                //     }

                //     if($pROW_ISSUE_SUM[$day1]==0)
                //       $xt1  = "";
                //     else
                //       $xt1  = $pROW_ISSUE_SUM[$day1];
                    
                //     if($pROW_Short_SUM[$day1]==0)
                //       $xt2  = "";
                //     else
                //       $xt2  = $pROW_Short_SUM[$day1];
                    
                //     if($pROW_Over_SUM[$day1]==0)
                //       $xt3  = "";
                //     else
                //       $xt3  = $pROW_Over_SUM[$day1];

                //     $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[ $xCol ] . $start_row, $xt1 );
                //     $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[ $xCol+1 ] . $start_row, $xt2 );
                //     $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[ $xCol+2 ] . $start_row, $xt3 );

                //     $t1 += $pROW_ISSUE_SUM[$day1];
                //     $t2 += $pROW_Short_SUM[$day1];
                //     $t3 += $pROW_Over_SUM[$day1];

                //     $ts1[$day1] += $pROW_ISSUE_SUM[$day1];
                //     $ts2[$day1] += $pROW_Short_SUM[$day1];
                //     $ts3[$day1] += $pROW_Over_SUM[$day1];
                ...
                // $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[(( ($count) *3)+2)] . $start_row, $t1);
                // $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[(( ($count) *3)+2)+1] . $start_row, $t2);
                // $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[(( ($count) *3)+2)+2] . $start_row, $t3);
    ...
    for ($day = 0; $day < $count; $day++) 
    {
      ...
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $mt1);
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $mt2);
      $r++;
      $objPHPExcel->getActiveSheet()->setCellValue($date_cell1[$r] . $start_row, $mt3);
      $r++;
      $xTotal_ISSUE_SUM += $ts1[$day];
      $xTotal_Short_SUM += $ts2[$day];
      $xTotal_Over_SUM  += $ts3[$day];
    }
