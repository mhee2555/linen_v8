...
function find_item($conn, $DATA)
{
  ...
  if ($radioFormat == '1') {
    if ($formatDay == '1') {
      $whereDate = "AND shelfcount.DocDate = '$oneday' ";
    } else {
...
function departmentWhere($conn, $DATA)
{
  ...
  WHERE time_express.HptCode = '$HptCode' ORDER BY time_sc.TimeName ";
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count_timeex]['ID'] = trim($Result['Time_ID']);
    $return[$count_timeex]['time_value'] = trim($Result['TimeName']);
    $count_timeex++;
    $boolean = true;
  }
  $return['Rowtimeex'] = $count_timeex;
...
function find_report($conn, $DATA)
{
  ...
  if ($typeReport == 1) {
    ...
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r29($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item,  'one', $time_express);
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r29($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, 'between', $time_express);
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r29($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, 'month', $time_express);
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r29($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, 'monthbetween', $time_express);
      }
    }
    ...
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r31($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode,  $category, $GroupCode, 'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r31($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r31($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r31($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'monthbetween');
      }
    }
  } else if ($typeReport == 32) {
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
    ...
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r33($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode,  $GroupCode,  'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r33($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode,  'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r33($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode,  'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
  ...
  } else if ($typeReport == 35) {
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r35($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode,  $category, $GroupCode, 'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r35($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r35($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r35($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode,  'monthbetween');
      }
    }
  } else if ($typeReport == 36) {
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r36($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, 'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r36($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, 'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r36($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, 'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r36($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, 'monthbetween');
      }
    }
  } else if ($typeReport == 37) {
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r37($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, 'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r37($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, 'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r37($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, 'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r37($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, 'monthbetween');
      }
    }
  } else if ($typeReport == 38) {
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r38($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, $type_usage_detail,  'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r38($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, $type_usage_detail, 'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r38($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, $type_usage_detail, 'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
    ...
    if ($Format == 1 || $Format == 3) {
      if ($FormatDay == 1 || $Format == 3) {
        $date1 = $date;
        $return = r39($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode,  $GroupCode,  'one');
      } else {
        $date1 = newDate1($date);
        $date2 = newDate2($date);
        $return = r39($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode,  'between');
      }
    } else if ($Format == 2) {
      if ($FormatMonth == 1) {
        $date1 = newMonth($date);
        $return = r39($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode,  'month');
      } else {
        $date1 = newMonth1($date);
        $date2 = newMonth2($date);
        $return = r39($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode,  'monthbetween');
      }
    }
  }
...
function r1($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, $chk)
{
  ...
  $return['url'] = '../report_linen/report/Report_Dirty_Linen_Weight_tc.php';
...
function r4($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $cycle, $chk)
{
  ...
  if ($Format == 1) {
    if ($chk == 'one') {
      ...
      WHERE DATE(shelfcount.complete_date) = '$date1' 
    ...
    if ($chk == 'month') {
     ...
     ";
      ...
      $betweendate1 = $year1 . '-' . $date1 . '-1';
      $betweendate2 = $year2 . '-' . $date2 . '-' . $lastday;
      $Sql = "SELECT shelfcount.DocNo, DATE(shelfcount.complete_date) AS DocDate, TIME(shelfcount.complete_date) AS DocTime, department.DepName
      FROM shelfcount
      INNER JOIN department ON shelfcount.DepCode = department.DepCode
    ...
    $Sql = "SELECT shelfcount.DocNo, DATE(shelfcount.complete_date) AS DocDate, TIME(shelfcount.complete_date) AS DocTime, department.DepName
              ...
              $DepCode1
              AND shelfcount.SiteCode = '$HptCode'
              AND shelfcount.isStatus <> 9  LIMIT 100
             ";
  }
...
function r5($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $chk)
{
  ...
  if ($Format == 1) {
    if ($chk == 'one') {
      ...
      AND shelfcount.DocNo LIKE '%$HptCode%'
      GROUP BY shelfcount.complete_date ORDER BY shelfcount.DocNo ASC";
    } else {
      $Sql = "SELECT shelfcount.DocNo,
      DATE(shelfcount.complete_date) AS DocDate,
      TIME(shelfcount.complete_date) AS DocTime,
      ...
      AND department.DepCode = $DepCode
      AND shelfcount.DocNo LIKE '%$HptCode%'
      GROUP BY MONTH(shelfcount.complete_date) ORDER BY shelfcount.DocNo ASC";
    }
  } else if ($Format == 2) {
    $date = subMonth($date1, $date2);
    isset($date['year1']) ? $year1 = $date['year1']  : $year1 = "";
    ...
    if ($chk == 'month') {
      ...
      FROM shelfcount
      INNER JOIN department ON shelfcount.DepCode = department.DepCode
      WHERE shelfcount.complete_date LIKE '%$date1%'
      AND department.DepCode = $DepCode
      AND shelfcount.DocNo LIKE '%$HptCode%'
      GROUP BY MONTH(shelfcount.complete_date) ORDER BY shelfcount.DocNo ASC";
    } else {
      ...
      AND department.DepCode = $DepCode
      AND shelfcount.DocNo LIKE '%$HptCode%'
      GROUP BY YEAR(shelfcount.complete_date) ORDER BY shelfcount.DocNo ASC LIMIT 1";
    }
  } else if ($Format == 3) {
    $Sql = "SELECT shelfcount.DocNo, DATE(shelfcount.complete_date) AS DocDate, TIME(shelfcount.complete_date) AS DocTime, department.DepName
              FROM shelfcount
              INNER JOIN department ON shelfcount.DepCode = department.DepCode
              WHERE shelfcount.complete_date LIKE '%$date1%'
              GROUP BY YEAR(shelfcount.complete_date) ORDER BY shelfcount.DocNo ASC";
  }
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2,   'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk];
  // $_SESSION['data_send'] = $data_send;
  $return['url'] = '../report_linen/report/Report_Daily_Issue_Request.php';
...
function r6($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $chk)
{
  ...
  if ($Format == 1) {
    ...
    if ($chk == 'month') {
      ...
      AND   YEAR(repair_wash.DocDate) = '$year1'
      AND repair_wash.FacCode = $FacCode
      AND site.hptcode = '$HptCode'
      GROUP BY MONTH (repair_wash.DocDate)
      ORDER BY repair_wash.DocDate ASC  LIMIT 1";
...
function r7($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $chk)
{
  ...
  if ($Format == 1) {
    ...
    if ($chk == 'month') {
      ...
      AND  YEAR(shelfcount.DocDate) = '$date1'
      AND (shelfcount_detail.Over <> 0 OR shelfcount_detail.Short <> 0 )
      AND shelfcount.isStatus <> 9
      AND shelfcount.isStatus <> 0
      AND department.HptCode = '$HptCode'
...
function r9($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $chk)
{
  ...
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    if ($DepCode == 'ALL') {
      $return[$count]['department'] = 'ทุกแผนก';
    } else {
  ...
  if ($Format == 1) {
    if ($chk == 'one') {
      $Sql = "SELECT
              ...
              WHERE DATE(shelfcount.DocDate) = '$date1'
              AND shelfcount.isStatus <> 9
              AND shelfcount.SiteCode = '$HptCode' LIMIT 1  ";
    } else {
      $Sql = "SELECT
              COUNT(shelfcount.DocNo)
              FROM
    ...
    if ($chk == 'month') {
      ...
      shelfcount
      WHERE MONTH(shelfcount.DocDate) = '$date1'
      AND   YEAR(shelfcount.DocDate) = '$year1' 
      AND shelfcount.isStatus <> 9
	    AND shelfcount.SiteCode = '$HptCode'
      GROUP BY MONTH(shelfcount.DocDate)  ";
    } else {
  ...
  if ($Format == 1) {
    ...
    if ($chk == 'month') {
      $Sql = "SELECT factory.FacName, newlinentable.DocDate, site.HptName
              ...
              AND  YEAR(newlinentable.DocDate) = '$year1'
              AND site.HptCode = '$HptCode'
              AND newlinentable.FacCode = $FacCode
              AND newlinentable.isStatus <> 9 
              GROUP BY MONTH (newlinentable.Docdate)
  ...
  if ($Format == 1) {
    ...
    if ($chk == 'month') {
      $Sql = "SELECT  damagenh.DocDate, site.HptName
              ...
              AND   YEAR(damagenh.DocDate) = '$year1'
              AND site.HptCode = '$HptCode'
             AND damagenh.IsStatus <> 9 AND damagenh.IsStatus <> 0       
              GROUP BY MONTH (damagenh.Docdate)
              ORDER BY damagenh.DocDate ASC";
  ...
  if ($Format == 2) {
    ...
    if ($chk == 'month') {
      $Sql = "SELECT site.HptName
              ...
              AND   YEAR(kpi_dirty1.DocDate) = '$year1'
  ...
  if ($Format == 2) {
    ...
    if ($chk == 'month') {
      $Sql = "SELECT site.HptName
              ...
              AND YEAR(kpi_clean1.DocDate) = '$year1'
              AND site.HptCode = '$HptCode'
    ...
    if ($chk == 'one') {
      $Sql = "SELECT  shelfcount.complete_date, site.HptName , department.DepName
        ...
        INNER JOIN grouphpt ON  grouphpt.HptCode = site.HptCode
                ...
                ORDER BY shelfcount.complete_date ASC limit 1 ";
    } else {
      $Sql = "SELECT  shelfcount.complete_date, site.HptName , department.DepName
        FROM
        shelfcount  
        ...
        INNER JOIN grouphpt ON  grouphpt.HptCode = site.HptCode
                ...
                AND shelfcount.isStatus <> 9 
                $GroupCode1
                GROUP BY MONTH (shelfcount.complete_date)
                ORDER BY shelfcount.complete_date ASC limit 1";
    }
  } else if ($Format == 2) {
    $date = subMonth($date1, $date2);
    ...
    if ($chk == 'month') {
      ...
      $Sql = " SELECT  shelfcount.complete_date, site.HptName , department.DepName
        ...
        INNER JOIN grouphpt ON  grouphpt.HptCode = site.HptCode
             ...
             $GroupCode1
             AND shelfcount.isStatus <> 9 
             GROUP BY YEAR (shelfcount.complete_date)
             ORDER BY shelfcount.complete_date ASC LIMIT 1";
    }
  } else if ($Format == 3) {
    $Sql = "  SELECT  shelfcount.complete_date, site.HptName , department.DepName
...
function r29($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, $chk, $time_express)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  if ($DepCode == "ALL") {
    ...
    $DepCode = "$DepCode";
    if ($Item <> '0') {
      $DepCode1 = "AND shelfcount_detail.itemCode = '$Item' AND shelfcount.DepCode = '$DepCode' ";
      $limit = 'limit 1';
    } else {
      $DepCode1 = "AND shelfcount.DepCode = '$DepCode' ";
    }
  ...
  if ($time_express == "ALL") {
    ...
    $time_express1 = "AND shelfcount.DeliveryTime = '$time_express'";
  }
  ...
  if ($Format == 1) {
    if ($chk == 'one') {
      $Sql = "SELECT  shelfcount.DocDate, site.HptName , department.DepName ,department.DepCode
              FROM
              shelfcount  
              INNER JOIN (SELECT DepCode , DepName , HptCode , GroupCode FROM department) AS department  ON department.DepCode = shelfcount.DepCode
              INNER JOIN (SELECT HptCode , HptName  FROM site) AS site ON site.HptCode = department.HptCode
              INNER JOIN (SELECT DocNo  , TotalQty , itemCode  FROM shelfcount_detail) AS shelfcount_detail ON shelfcount_detail.DocNo = shelfcount.DocNo
              INNER JOIN (SELECT HptCode  FROM grouphpt ) AS grouphpt ON grouphpt.HptCode = site.HptCode 
  ...
  $return['sql'] = $Sql;
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2, 'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk, 'year1' => $year1, 'year2' => $year2, 'item' => $Item, 'time_express' => $time_express];
  //$_SESSION['data_send'] = $data_send;
...
function r31($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  if ($category == "0") {
    ...
    $category = "$category";
    $category1 = "AND report_billing_detail.CategoryCode = $category";
  }
  if ($GroupCode == "0") {
    $GroupCode  = "0";
    $GroupCode1 = "";
    ...
    $GroupCode = "$GroupCode";
    $GroupCode1 = "AND report_billing_detail.Groupcode = $GroupCode";
  }
  #วัน
  if ($Format == 1) {
    if ($chk == 'one') {
      $Sql = "SELECT
                ...
                department.DepName 
              FROM
                report_billing_detail
                INNER JOIN department ON report_billing_detail.DepCode = department.DepCode
                INNER JOIN site ON report_billing_detail.Site = site.HptCode 
              WHERE
                DATE( report_billing_detail.DocDate ) = DATE( '$date1' ) 
                AND report_billing_detail.Site = '$HptCode'
                $category1
                $GroupCode1
                LIMIT 1";
    } else {
      $Sql = "SELECT
              ...
              FROM
                ...
                INNER JOIN site ON report_billing_detail.Site = site.HptCode 
              WHERE
                DATE( report_billing_detail.DocDate ) BETWEEN '$date1' AND '$date2'
                AND report_billing_detail.Site = '$HptCode'
                $category1
                $GroupCode1
                LIMIT 1";
    ...
    if ($chk == 'month') {
      $Sql = "SELECT
              ...
              FROM
                ...
                INNER JOIN site ON report_billing_detail.Site = site.HptCode 
              WHERE
                       MONTH (report_billing_detail.DocDate) = '$date1'
                  AND  YEAR (report_billing_detail.DocDate) = '$year1'
                  AND report_billing_detail.Site = '$HptCode'
                  $category1 
                  $GroupCode1
                  LIMIT 1";
      ...
      $Sql = " SELECT
                  ...
                  $GroupCode2
                  WHERE
                    DATE(shelfcount.complete_date) BETWEEN '$betweendate1'
                  AND '$betweendate2'
                  AND site.HptCode = '$HptCode' 
                  $category1 
                  $GroupCode
  ...
  #ปี
    ...
    $Sql = "  SELECT
              ...
              FROM
                ...
                INNER JOIN site ON report_billing_detail.Site = site.HptCode 
              WHERE
                    YEAR (report_billing_detail.DocDate) = '$date1'
                    AND report_billing_detail.Site = '$HptCode'
                  $category1 
                  $GroupCode1
                  LIMIT 1";
  ...
  //$_SESSION['data_send'] = $data_send;
  $return['urlxls'] = '../report_linen/excel/Report_Billing_category_xls.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['HptName'] = $Result['HptName'];
    $return[$count]['DocDate'] = $Result['DocDate'];
    ...
    if ($chk == 'month') {
      $Sql = "SELECT  return_doc.DocDate, site.HptName , department.DepName
          ...
          LEFT JOIN item_category ON item_category.CategoryCode = item.CategoryCode
                  ...
                  AND   YEAR(return_doc.DocDate) = '$year1'
                  AND site.HptCode = '$HptCode'
                  $GroupCode1
                  $category1
                  AND return_doc.isStatus <> 9 
...
function r33($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2, 'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk, 'year1' => $year1, 'year2' => $year2, 'GroupCode' => $GroupCode];
  //$_SESSION['data_send'] = $data_send;
  $return['urlxls'] = '../report_linen/excel/Report_Monitoring_SAP_xls.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['HptName'] = $Result['HptName'];
    $count++;
...
function r35($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $category, $GroupCode, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  if ($GroupCode == "0") {
    ...
    $GroupCode = "$GroupCode";
    $GroupCode1 = "AND grouphpt.GroupCode = $GroupCode";
    $GroupCode2 = "INNER JOIN grouphpt ON grouphpt.HptCode = site.HptCode";
  }
  #วัน
  if ($Format == 1) {
    if ($chk == 'one') {
  ...
  #เดือน
    ...
    if ($chk == 'month') {
      $Sql = "SELECT
                  ...
                  $GroupCode2
                  WHERE
                       MONTH (shelfcount.complete_date) = '$date1'
                  AND  YEAR (shelfcount.complete_date) = '$year1'
                  AND site.HptCode = '$HptCode'
                  $category1 
                  $GroupCode1
  ...
  #ปี
    ...
    $Sql = "  SELECT
                  ...
                  $GroupCode2
                  WHERE
                    YEAR (shelfcount.complete_date) = '$date1'
                  AND site.HptCode = '$HptCode' 
                  $category1 
                  $GroupCode1
                  AND report_sc.isStatus <> 9
  ...
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2, 'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk, 'year1' => $year1, 'year2' => $year2, 'GroupCode' => $GroupCode, 'category' => $category];
  //$_SESSION['data_send'] = $data_send;
  $return['urlxls'] = '../report_linen/excel/Report_Billing_category_test_xls.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['HptName'] = $Result['HptName'];
    $return[$count]['DocDate'] = $Result['DocDate'];
...
function r36($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $time_dirty, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  $return['urlxls'] = '../report_linen/excel/Report_Dirty_Linen_Weight_xls_test.php';
  $return['555'] = $Sql;
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['FacName'] = $Result['facname'];
...
function r37($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  //$_SESSION['data_send'] = $data_send;
  $return['url'] = '../report_linen/report/Report_Cleaned_Linen_Weight_tc.php';
  $return['urlxls'] = '../report_linen/excel/Report_Cleaned_Linen_Weight_xls_test.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['HptName'] = $Result['HptName'];
    $return[$count]['FacName'] = $Result['FacName'];
...
function r38($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $Item, $type_usage_detail, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2, 'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk, 'year1' => $year1, 'year2' => $year2, 'item' => $Item, 'type_usage_detail' => $type_usage_detail];
  //$_SESSION['data_send'] = $data_send;
  $return['urlxls'] = '../report_linen/excel/Report_Usage_Detail_new_xls_test.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return['department'][$count]['HptName'] = $Result['HptName'];
    $return['department'][$count]['DocDate'] = $Result['DocDate'];
...
function r39($conn, $HptCode, $FacCode, $date1, $date2, $Format, $DepCode, $GroupCode, $chk)
{
  $betweendate1 = "";
  $betweendate2  = "";
  $year1  = "";
  ...
  $data_send = ['HptCode' => $HptCode, 'FacCode' => $FacCode, 'date1' => $date1, 'date2' => $date2, 'betweendate1' => $betweendate1, 'betweendate2' => $betweendate2, 'Format' => $Format, 'DepCode' => $DepCode, 'chk' => $chk, 'year1' => $year1, 'year2' => $year2, 'GroupCode' => $GroupCode];
  //$_SESSION['data_send'] = $data_send;
  $return['urlxls'] = '../report_linen/excel/Report_REPLENISHMENT_SAP_xls.php';
  $meQuery = mysqli_query($conn, $Sql);
  while ($Result = mysqli_fetch_assoc($meQuery)) {
    $return[$count]['HptName'] = $Result['HptName'];
    $return[$count]['DocDate'] = $Result['DocDate'];
