...
function CreateDocument($conn, $DATA)
{
  ...
  // $title = "554545";
  // $body = "กรุณากดรับเอกสาร " . $title . " ("."ทดสอบส่งจากเว็ป)";
  // $userId = 365;

  // new SendNotification($userId, $title, $body);
...
function ShowDocument($conn, $DATA)
{
  ...
  if ($process == 'chkpro1') {
    ...
    $whereDep = "";
  if($deptCode != 'chkdep'){
    $whereDep = " AND  shelfcount.DepCode = '$deptCode' ";
    $joindep = "";
    $depname = "";
  }else{
    $joindep = " INNER JOIN (SELECT department.DepName,department.DepCode FROM department) AS department ON shelfcount.DepCode = department.DepCode ";
    $depname = " department.DepName,";
  }
    $whereDate = "";
  if($datepicker !=  null){
    $whereDate = " AND  shelfcount.DocDate = '$datepicker' ";
  }
    $whereProcess = "";
  if($process != 'chkpro'){
    $whereProcess = " AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) ";
  }
  if ($Hotp <> "chkhpt") {
    $Sql = "SELECT        
                            $depname
  ...
  FROM shelfcount
  $joindep
	INNER JOIN (SELECT users.ThPerfix,users.EngPerfix,users.ThLName,users.ThName,users.EngLName,users.EngName,users.ID FROM users) AS users ON shelfcount.Modify_Code = users.ID
	LEFT  JOIN (SELECT sc_time_2.TimeName,sc_time_2.ID FROM sc_time_2) AS sc_time_2 ON shelfcount.ScTime = sc_time_2.ID  
  WHERE shelfcount.SiteCode = '$Hotp' 
  AND   shelfcount.DocNo LIKE '%$xDocNo%'
  AND   shelfcount.IsMobile = 1
  AND ( shelfcount.statusDepartment = 1 OR shelfcount.statusDepartment  IS NULL  )
        $whereDep
        $whereDate
        $whereProcess 
  ORDER BY shelfcount.DocNo DESC LIMIT 500  ";
    ...
    //   $chk = 1;
    //   $Sql .= " WHERE  shelfcount.SiteCode = '$Hotp' AND department.HptCode = '$Hotp' AND   shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  ) ";
    ...
    // } else if ($Hotp == 'chkhpt' && $deptCode == 'chkdep' && $datepicker != null && $process == 'chkpro') {
    //   $chk = 3;
    //   $Sql .= " WHERE shelfcount.DocDate = '$datepicker' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode != 'chkdep' && $datepicker == null && $process == 'chkpro') {
    //   $chk = 4;
    //   $Sql .= " WHERE  shelfcount.SiteCode = '$Hotp' AND department.HptCode = '$Hotp'   AND shelfcount.DepCode = '$deptCode' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode == 'chkdep' && $datepicker != null && $process == 'chkpro') {
    //   $chk = 5;
    //   $Sql .= " WHERE shelfcount.SiteCode = '$Hotp' AND department.HptCode = '$Hotp'    AND  shelfcount.DocDate = '$datepicker' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp == 'chkhpt' && $deptCode != 'chkdep' && $datepicker != null && $process == 'chkpro') {
    //   $chk = 6;
    //   $Sql .= " WHERE shelfcount.DepCode = '$deptCode' AND shelfcount.DocDate = '$datepicker' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode != 'chkdep' && $datepicker != null  && $process == 'chkpro') {
    //   $chk = 7;
    //   $Sql .= " WHERE shelfcount.DepCode = '$deptCode'  AND  shelfcount.DocDate = '$datepicker' AND site.HptCode = '$Hotp' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode == 'chkdep' && $datepicker == null && $process != 'chkpro') {
    //   $chk = 8;
    //   $Sql .= " WHERE  shelfcount.SiteCode = '$Hotp'  AND department.HptCode = '$Hotp'  AND  shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1 AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp == 'chkhpt' && $deptCode != 'chkdep' && $datepicker == null && $process != 'chkpro') {
    //   $chk = 9;
    //   $Sql .= " WHERE shelfcount.DepCode = '$deptCode'  AND shelfcount.IsMobile = 1  AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp == 'chkhpt' && $deptCode == 'chkdep' && $datepicker != null && $process != 'chkpro') {
    //   $chk = 10;
    //   $Sql .= " WHERE shelfcount.DocDate = '$datepicker'  AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1  AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode == 'chkdep' && $datepicker != null && $process != 'chkpro') {
    //   $chk = 11;
    //   $Sql .= " WHERE shelfcount.SiteCode = '$Hotp' AND department.HptCode = '$Hotp'  AND shelfcount.DocDate = '$datepicker' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1  AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) AND ( statusDepartment = 1 OR statusDepartment  IS NULL  )  ";
    // } else if ($Hotp != 'chkhpt' && $deptCode != 'chkdep' && $datepicker != null && $process != 'chkpro') {
    //   $chk = 12;
    //   $Sql .= " WHERE shelfcount.SiteCode = '$Hotp' AND department.HptCode = '$Hotp'  AND shelfcount.DepCode = '$deptCode' AND  shelfcount.DocDate = '$datepicker' AND shelfcount.DocNo LIKE '%$xDocNo%' AND shelfcount.IsMobile = 1  AND ( shelfcount.IsStatus = $onprocess1 OR shelfcount.IsStatus = $onprocess2 ) AND ( statusDepartment = 1 OR statusDepartment IS NULL )  ";
    // }

    // $Sql .= "AND department.IsActive = 1 ORDER BY shelfcount.DocNo DESC LIMIT 500 ";
    $return['sql'] = $Sql;
    $return['chk'] = $chk;
    $meQuery = mysqli_query($conn, $Sql);
    while ($Result = mysqli_fetch_assoc($meQuery)) {
      ...
      $return[$count]['HptName']      = $HotpName;

      if($deptCode != 'chkdep'){
        $return[$count]['DepName']      = $DepName;
      }else{
        $return[$count]['DepName']      = $Result['DepName'];
      }
      $return[$count]['DocNo']           = $Result['DocNo'];
...
function ShowItem($conn, $DATA)
{
  ...
  $Sql = "SELECT
          ...
          WHERE  par_item_stock.DepCode = '$deptCode' 
            ...
            AND  par_item_stock.ItemCode NOT IN (SELECT shelfcount_detail.ItemCode FROM shelfcount_detail WHERE shelfcount_detail.DocNo = '$DocNo' )
          GROUP BY 
            item.ItemCode
          ORDER BY 
            item.ItemName ASC 
...
function getImport($conn, $DATA)
{
  ...
  FROM
    ...
    INNER JOIN item ON par_item_stock.ItemCode = item.ItemCode 
  WHERE
    par_item_stock.ItemCode = '$iItemStockId' 
    AND par_item_stock.DepCode = '$deptCode' 
  GROUP BY
    item.ItemCode  ";
    $report_result  = mysqli_query($conn, $report_Sql);
    $report_row     = mysqli_fetch_assoc($report_result);
    $DepCode    =  $report_row['DepCode'];
    $CategoryCode    =  $report_row['CategoryCode'];
    $ItemCode    =  $report_row['ItemCode'];
    $ItemName    =  $report_row['ItemName'];
    $ParQty    =  $report_row['ParQty'];
    $Weight    =  $report_row['Weight'];
        ...
        (DocNo,ItemCode,ParQty,IsCancel) VALUES
        ('$DocNo','$ItemCode',$ParQty,0)";

        $Sql2 = "INSERT INTO report_sc
                  SET 
                  report_sc.DocNo = '$DocNo' ,
                  report_sc.ItemCode = '$ItemCode' ,
                  report_sc.DocDate = DATE(NOW()),
                  report_sc.ItemName = '$ItemName',
                  report_sc.WeightPerQty = '$Weight',
                  report_sc.CategoryCode = '$CategoryCode',
                  report_sc.DepCode = '$DepCode' ,
                  report_sc.ParQty = '$ParQty' ";
...
function SaveBill($conn, $DATA)
{
  ...
  $sqldel = " DELETE FROM shelfcount_detail WHERE shelfcount_detail.DocNo = '$DocNo' AND shelfcount_detail.CcQty = 0 AND shelfcount_detail.TotalQty = 0 ";
...
function ShowDetailNew1st($conn, $DATA){
  $countqty = 0;
  $count = 0;
  $Total = 0;
  $boolean = false;
  ...
  $deptCode = $DATA["deptCode"];
    ...
    $sc_sql = "SELECT
                ...
                FROM
                  shelfcount 
                WHERE shelfcount.DocNo = '$DocNo'";
    $sc_meQuery = mysqli_query($conn, $sc_sql);
    $sc_Result = mysqli_fetch_assoc($sc_meQuery);
    $return['ScTime']               = $sc_Result['ScTime']; 
...
function UpdateNewQty1st($conn, $DATA)
{
  $RowID        = $DATA["RowID"];
  $NewQty       =  $DATA["NewQty"];
  $Issue        =  $DATA["Issue"];
  ...
  $checkItem = "SELECT COUNT(ItemCode) AS count_item FROM shelfcount_detail WHERE shelfcount_detail.ItemCode = '$itemcode' AND shelfcount_detail.DocNo = '$DocNo'  ";
  $check_result  = mysqli_query($conn, $checkItem);
  $check_row     = mysqli_fetch_assoc($check_result);
  $count_item    =  $check_row['count_item'];

  $find_Dep = "SELECT DepCode FROM shelfcount WHERE shelfcount.DocNo = '$DocNo'  ";
  $find_result  = mysqli_query($conn, $find_Dep);
  $find_row     = mysqli_fetch_assoc($find_result);
  $DepCode    =  $find_row['DepCode'];
  ...
  $report_Sql = "SELECT
            ...
            FROM
              ...
              INNER JOIN item ON par_item_stock.ItemCode = item.ItemCode 
            WHERE
              par_item_stock.ItemCode = '$itemcode' 
              AND	par_item_stock.DepCode = '$DepCode'
            GROUP BY
              item.ItemCode  ";
  $report_result  = mysqli_query($conn, $report_Sql);
    ...
    if ($Issue != "" || $Issue != 0) {
      if ($chk == "Over") {
        $Sql = "INSERT INTO shelfcount_detail
                ...
                shelfcount_detail.Short    = 0,
                shelfcount_detail.DocNo = '$DocNo' ,
                shelfcount_detail.ItemCode = '$itemcode' ,
                shelfcount_detail.ParQty = '$ParQty'  ";
  ...
  $Update   = "UPDATE shelfcount_detail,
                report_sc 
                SET shelfcount_detail.Price = $Pricex,
                report_sc.Price = $Pricex 
                WHERE
                  shelfcount_detail.ItemCode = '$itemcode' 
...
if (isset($_POST['DATA'])) {
  ...
  if ($DATA['STATUS'] == 'OnLoadPage') {
    ...
    ShowDetailNew($conn, $DATA);
  } elseif ($DATA['STATUS'] == 'ShowDetailNew1st') {
    ShowDetailNew1st($conn, $DATA);
  } elseif ($DATA['STATUS'] == 'UpdateNewQty') {
    UpdateNewQty($conn, $DATA);
  } elseif ($DATA['STATUS'] == 'UpdateNewQty1st') {
    UpdateNewQty1st($conn, $DATA);
