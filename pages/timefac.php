                ...
                success: function(result) {
                    ...
                    if (temp["status"] == 'success') {
                        if ((temp["form"] == 'getSection')) {
                            ...
                            $("#selectTime").empty()
                            var StrTr = "<option value=''><?php echo $array['settimefac'][$language]; ?></option>";
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active"><?php echo $array2['menu']['system']['sub'][19][$language]; ?></li>
</ol>
    <div id="wrapper">
        <!-- content-wrapper -->
   ...
   <!-- =================================================================== -->
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <label class="col-sm-3 col-form-label "><?php echo $array['settimefac'][$language]; ?></label>
