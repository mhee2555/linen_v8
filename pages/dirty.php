    ...
    //==============================
        ...
        function PrintData(){
          ...
          if(docno!=""&&docno!=undefined){
            var url  = "../report/Report_Dirty_tc.php?DocNo="+docno+"&lang="+lang+"&HptCode="+HptCode;
            window.open(url);
          }else{
            swal({
              title: '',
            ...
            <div class="row">
              <div class="col-md-12" style='padding-left: 26px;' id='switch_col'>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" onclick=" ShowDocument()"  href="#profile" role="tab" aria-controls="profile" aria-selected="false"><?php echo $array['search'][$language]; ?></a>
                  </li>
                </ul>
