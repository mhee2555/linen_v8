          ...
          if (!$.isEmptyObject(ObjData)) {
            $.each(ObjData, function(kay, value) {
              ...
              StrTR += "<tr>" +
                ...
                "<td ><input id='input32_" + kay + "' autocomplete='off' type='text' class='form-control width_custom input32' ></td>" +
            ...
            StrTR += "<tr>" +
              ...
              "<td ><input id='sum_input32'   autocomplete='off' type='text' class='form-control width_custom' disabled></td>" +
        ...
        swal({
          ...
          if (result.value) {
            ...
            $(".loopitemcode").each(function(key, value) {
              ...
              objItem.itemQty[0][26] = objItem.itemQty[0][26].replace("%",'');
              
              objItem.itemQty[0][0] = (objItem.itemQty[0][0] == '')  ? '0' : objItem.itemQty[0][0];
              objItem.itemQty[0][1] = (objItem.itemQty[0][1] == '')  ? '0' : objItem.itemQty[0][1];
              objItem.itemQty[0][2] = (objItem.itemQty[0][2] == '')  ? '0' : objItem.itemQty[0][2];
              objItem.itemQty[0][3] = (objItem.itemQty[0][3] == '')  ? '0' : objItem.itemQty[0][3];
              objItem.itemQty[0][4] = (objItem.itemQty[0][4] == '')  ? '0' : objItem.itemQty[0][4];
              objItem.itemQty[0][5] = (objItem.itemQty[0][5] == '')  ? '0' : objItem.itemQty[0][5];
              objItem.itemQty[0][6] = (objItem.itemQty[0][6] == '')  ? '0' : objItem.itemQty[0][6];
              objItem.itemQty[0][7] = (objItem.itemQty[0][7] == '')  ? '0' : objItem.itemQty[0][7];
              objItem.itemQty[0][8] = (objItem.itemQty[0][8] == '')  ? '0' : objItem.itemQty[0][8];
              objItem.itemQty[0][9] = (objItem.itemQty[0][9] == '')  ? '0' : objItem.itemQty[0][9];
              objItem.itemQty[0][10] = (objItem.itemQty[0][10] == '')  ? '0' : objItem.itemQty[0][10];
              objItem.itemQty[0][11] = (objItem.itemQty[0][11] == '')  ? '0' : objItem.itemQty[0][11];
              objItem.itemQty[0][12] = (objItem.itemQty[0][12] == '')  ? '0' : objItem.itemQty[0][12];
              objItem.itemQty[0][13] = (objItem.itemQty[0][13] == '')  ? '0' : objItem.itemQty[0][13];
              objItem.itemQty[0][14] = (objItem.itemQty[0][14] == '')  ? '0' : objItem.itemQty[0][14];
              objItem.itemQty[0][15] = (objItem.itemQty[0][15] == '')  ? '0' : objItem.itemQty[0][15];
              objItem.itemQty[0][16] = (objItem.itemQty[0][16] == '')  ? '0' : objItem.itemQty[0][16];
              objItem.itemQty[0][17] = (objItem.itemQty[0][17] == '')  ? '0' : objItem.itemQty[0][17];
              objItem.itemQty[0][18] = (objItem.itemQty[0][18] == '')  ? '0' : objItem.itemQty[0][18];
              objItem.itemQty[0][19] = (objItem.itemQty[0][19] == '')  ? '0' : objItem.itemQty[0][19];
              objItem.itemQty[0][20] = (objItem.itemQty[0][20] == '')  ? '0' : objItem.itemQty[0][20];
              objItem.itemQty[0][21] = (objItem.itemQty[0][21] == '')  ? '0' : objItem.itemQty[0][21];
              objItem.itemQty[0][22] = (objItem.itemQty[0][22] == '')  ? '0' : objItem.itemQty[0][22];
              objItem.itemQty[0][23] = (objItem.itemQty[0][23] == '')  ? '0' : objItem.itemQty[0][23];
              objItem.itemQty[0][24] = (objItem.itemQty[0][24] == '')  ? '0' : objItem.itemQty[0][24];
              objItem.itemQty[0][25] = (objItem.itemQty[0][25] == '')  ? '0' : objItem.itemQty[0][25];
              objItem.itemQty[0][26] = (objItem.itemQty[0][26] == '')  ? '0' : objItem.itemQty[0][26];
              objItem.itemQty[0][27] = (objItem.itemQty[0][27] == '')  ? '0' : objItem.itemQty[0][27];
              objItem.itemQty[0][28] = (objItem.itemQty[0][28] == '')  ? '0' : objItem.itemQty[0][28];
              objItem.itemQty[0][29] = (objItem.itemQty[0][29] == '')  ? '0' : objItem.itemQty[0][29];
              objItem.itemQty[0][30] = (objItem.itemQty[0][30] == '')  ? '0' : objItem.itemQty[0][30];
          ...
          if (!$.isEmptyObject(ObjData)) {
            $.each(ObjData.data, function(kay, value) {
              ...
              StrTR += "<tr>" +
                ...
                "<td ><input id='input32_" + kay + "' autocomplete='off' type='text' class='form-control width_custom input32'  value=" + value.Input32 + "></td>" +
    ...
    <div class="tab-pane show active fade" id="home" role="tabpanel" aria-labelledby="home-tab">
      ...
      <table style="margin-top:10px;" class="table mt-2 table-bordered " id="TableItem" cellspacing="0" role="grid">
        <thead id="theadsum" style="font-size:11px;">
          <tr role="row">
            <th class='text-center' nowrap colspan="9">Linen Stock Count</th>
          ...
          <tr role="row">
            ...
            <th class='text-center' nowrap>รับผ้าเข้าภายในวันที่</th>
