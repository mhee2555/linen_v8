...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?php echo $array2['menu']['general']['sub'][22][$language]; ?></li>
  </ol>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class='form-group row'>
                  <label class="col-sm-4 col-form-label">
                  <?php echo $array['depremessage'][$language]; ?>
                  </label>
                  <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-7  " id="txtmessage" placeholder="<?php echo $array['plsdepremessage'][$language]; ?>">
                  <label id="alert_message" class="col-sm-1 " style="font-size: 40%;margin-top: 1%;"> <i class="fas fa-asterisk text-danger"></i> </label>
                </div>
              </div>
            </div>
            <div class="row">
        ...
        <table class="table table-fixed table-condensed table-striped mt-3" id="tableDocument" width="100%" cellspacing="0" role="grid">
          <thead id="theadsum" style="font-size:24px;">
            <tr role="row" id='tr_1'>
              ...
              <th nowrap style="width:10%;"><?php echo $array['depRequest'][$language]; ?></th>
  ...
  <script type="text/javascript">
    ...
    function createDocument() {
      ...
      if (txtmessage == "") {
        swal({
          title: '',
          text: 'กรุณากรอกข้อความที่ต้องการร้องขอ',
          type: 'warning',
          ...
          if (!$.isEmptyObject(ObjData)) {
            $.each(ObjData, function(key, value) {
              ...
              StrTR += "<tr style='border-radius: 15px 15px 15px 15px;margin-top: 6px;margin-bottom: 6px;'>" +
                ...
                "<td style='width:10%;text-overflow: ellipsis;overflow: hidden;' nowrap title='" + value.Message + "'>" + value.Message + "</td>" +
