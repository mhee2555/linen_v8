...
<head>
  ...
  <script type="text/javascript">
          ...
          success: function(result) {
            ...
            if (!$.isEmptyObject(ObjData)) {
              $.each(ObjData, function(key, value) {
                $('#hotpital').val(value.SiteCode);
                $('#hotpital').attr('disabled', true);
                $('#department').val(value.DepCode);
                $('#department').attr('disabled', true);
                $('#select2-department-container').text(value.DepName);
                $('#docdate').val(value.DocDate);
                $('#docno').val(value.DocNo);
                $('#recorder').val(value.ThName);
                $('#timerec').val(value.Modify_Date);
                ...
                // ShowDocDetail_Menu(Docnomenu, value.SiteCode);
                ShowDetailNew();
              });
    ...
    // function ShowDocDetail_Menu(Docnomenu, SiteCode) {
    //   $.ajax({
    //     url: "../process/shelfcountMenu.php",
    //     type: 'POST',
    //     data: {
    //       'FUNC_NAME': 'ShowDocDetail_Menu',
    //       'DocNo': Docnomenu,
    //       'SiteCode': SiteCode,
    //     },
    //     success: function(result) {
    ...
    //           var Sc = "<div class='row' style='margin-left:2px;'><button class='btn btn_mhee inputDis' style='height:40px;width:32px;' onclick='DelTotalQty(\"" + value.Id + "\",\"" + i + "\",\"" + value.ParQty + "\",\"" + value.ItemCode + "\")'>-</button>" +
    //             "<input name='Sc_save' autocomplete='off' class='form-control numonly QtyItem inputDis' style='height:40px;width:60px; margin-left:3px; margin-right:3px; text-align:center;' id='qty1_" + i + "' value='" + value.CcQty + "' onchange='KeyNewCcQty(\"" + value.Id + "\",\"" + i + "\",\"" + value.ParQty + "\" ,\"" + value.ItemCode + "\")'>" +
    //             "<button class='btn btn_mheesave inputDis' style='height:40px;width:32px;' onclick='addTotalQty(\"" + value.Id + "\",\"" + i + "\",\"" + value.ParQty + "\",\"" + value.ItemCode + "\")'>+</button></div>";

    //           var Par = "<input autocomplete='off' class='form-control' id='Par_" + i + "' type='text' style='text-align:center;font-size: 24px!important' disabled value='" + value.ParQty + "'>";

    //           var Issue = "<input name='Issue_save' autocomplete='off' class='form-control decimal numonly inputDis' id='Issue_" + i + "'  type='text' style='text-align:center;font-size: 24px!important' placeholder='0' value='" + value.TotalQty + "' onchange='KeyNewTotalQty(\"" + value.Id + "\",\"" + i + "\" ,\"" + value.ItemCode + "\"  )'>";
    ...
    //           var Short = "<input name='Short_save'  autocomplete='off' class='form-control' id='Short_" + i + "'  type='text' style='text-align:center;font-size: 24px!important' disabled value='" + value.Short + "'>";

    //           var Over = "<input name='Over_save' autocomplete='off' class='form-control' id='Over_" + i + "'  type='text' style='text-align:center;font-size: 24px!important' disabled value='" +  value.Over + "'>";

    //           var Weight = "<input name='Weight_save' autocomplete='off' class='form-control WeightItem'  id='Weight_" + i + "' type='text' style='text-align:center;font-size: 24px!important'  disabled value='" + value.Weight + "'>";

    //           var Weight2 = "<input  autocomplete='off' class='form-control WeightItem'  id='Weight2_" + i + "' type='text' style='text-align:center;font-size: 24px!important'  disabled value='" + value.Weightitem + "'>";

    //           var Price = "<input hidden name='Price_save'  autocomplete='off' class='form-control PriceItem'  id='Price2_" + i + "' type='text' style='text-align:center;font-size: 24px!important'  disabled value='" + value.Price + "'>";

    //           StrTR += "<tr id='tr" + value.Id + "' style='border-radius: 15px 15px 15px 15px;margin-top: 6px;margin-bottom: 6px;'>" +
    //             "<td style='width: 5%;'nowrap>" + (i + 1) + "</td>" +
    //             "<td style='width: 21%;'>" + value.ItemCode + "</td>" +
    ...
    //             "<td><input type='hidden' id='item_array" + value.ItemCode + "' value='" + value.ItemCode + "' class='item_array'></input></td>" +
    //             "</tr>";
    //         });
    //         $('#TableItemDetail tbody').html(StrTR);
    //       }
    //     }
    //   });
    // }
    ...
    function ShowDocument(selecta) {
      ...
      var Hotp = $('#side option:selected').attr("value");
      var HotpName = $('#side option:selected').text();
      ...
      var DepName = $('#Dep2 option:selected').text();
    ...
    function ShowDetailNew1st() {
      var docno = $("#docno").val();
      var hotpCode = $("#hotpital").val();
      var deptCode = $('#department option:selected').attr("value");

      var data = {
        'STATUS': 'ShowDetailNew1st',
        'DocNo': docno,
        'HptCode': hotpCode,
        'deptCode': deptCode
      };
    ...
    function addTotalQty(RowID, i, iMax, itemcode , ScTime) {
    ...
    function addTotalQty1st(RowID, i, iMax, itemcode , ScTime) {
      var NewQty = Number($('#qty1_' + i).val()) + 1;
      var Max = Number(iMax);
      var Issue = Number($('#Issue_' + i).val());
      var Result = 0;
    ...
    function DelTotalQty(RowID, i, iMax, itemcode , ScTime) {
      var NewQty = Number($('#qty1_' + i).val()) - 1;
      var Issue = Number($('#Issue_' + i).val());
      var Max = Number(iMax);
      var Result = 0;
    ...
    function DelTotalQty1st(RowID, i, iMax, itemcode , ScTime) {
      var NewQty = Number($('#qty1_' + i).val()) - 1;
      var Issue = Number($('#Issue_' + i).val());
      var Max = Number(iMax);
      var Result = 0;
    ...
    function KeyNewCcQty(RowID, i, iMax, itemcode,ScTime) {
    ...
    function KeyNewCcQty1st(RowID, i, iMax, itemcode,ScTime) {
      var NewQty = Number($('#qty1_' + i).val());
      var Issue = Number($('#Issue_' + i).val());
      var Max = Number(iMax);
      var Result = 0;
    ...
    function KeyNewTotalQty(RowID, i, itemcode,ScTime) {
      var NewQty = Number($('#qty1_' + i).val());
    ...
    function KeyNewTotalQty1st(RowID, i, itemcode,ScTime) {
      var NewQty = Number($('#qty1_' + i).val());
      var Max = Number($('#Max_' + i).val());
      var Issue = Number($('#Issue_' + i).val());
      if(ScTime == "0"){
    ...
    function Calculate(loop,ScTime) {
        ...
        success: function(result) {
          ...
          if (temp["status"] == 'success') {
            if (temp["form"] == 'OnLoadPage') {
              ...
              $("#docno").val(temp[0]['DocNo']);
              $("#docdate").val(temp[0]['DocDate']);
              $("#txtRemark").val(temp[0]['remark']);
              $("#recorder").val(temp[0]['Record']);
              $("#timerec").val(temp[0]['RecNow']);
              $("#IsStatus").val(temp[0]['IsStatus']);
              $("#txtPhoneNumber").val(temp[0]['phoneNumber']);
              ...
              if (temp["Row"] > 0) {
                for (var i = 0; i < temp["Row"]; i++) {
                  ...
                  var chkDoc = "<input type='checkbox' name='checkitem'  id='checkrow_" + i + "' class='checkitem' onclick='dis2(\"" + i + "\")' value='" + i + "'><input type='hidden' id='RowID" + i + "' value='" + temp[i]['ItemCode'] + "'>";


                  $StrTR = "<tr id='tr" + temp[i]['ItemCode'] + "' style='border-radius: 15px 15px 15px 15px;margin-top: 6px;margin-bottom: 6px;'>" +
                    "<td style='width: 64%;'nowrap>" + chkDoc + " <label style='margin-left:10px;'> " + (i + 1) + "</label></td>" +
                    "<td style='width: 36%;cursor: pointer;' )''nowrap>" + temp[i]['ItemName'] + "</td>" +
                    "</tr>";
                    $("#tbody_modal").append($StrTR);
                }
              } else {
                $('#tbody_modal').empty();
                var Str = "<tr width='100%'><td style='width:100%' class='text-center'><?php echo $array['notfoundmsg'][$language]; ?></td></tr>";
                $("#tbody_modal").append($Str);
              }
              ...
              for (var i = 0; i < temp["Row"]; i++) {
                var rowCount = $('#TableItemDetail >tbody >tr').length;
                var Sc = "<div class='row' style='margin-left:2px;'><button class='btn btn_mhee inputDis' style='height:40px;width:32px;' onclick='DelTotalQty(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\",\"" + temp[i]['ItemCode'] + "\",\"" + temp['ScTime'] + "\")'>-</button>" +
                  "<input name='Sc_save' autocomplete='off' class='form-control numonly QtyItem inputDis' style='height:40px;width:60px; margin-left:3px; margin-right:3px; text-align:center;' id='qty1_" + i + "' value='" + temp[i]['CcQty'] + "' onchange='KeyNewCcQty(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\" ,\"" + temp[i]['ItemCode'] + "\" ,\"" + temp['ScTime'] + "\")'>" +
                  "<button class='btn btn_mheesave inputDis' style='height:40px;width:32px;' onclick='addTotalQty(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\",\"" + temp[i]['ItemCode'] + "\",\"" + temp['ScTime'] + "\")'>+</button></div>";
                ...
                var Issue = "<input name='Issue_save' autocomplete='off' class='form-control decimal numonly inputDis' id='Issue_" + i + "'  type='text' style='text-align:center;font-size: 24px!important' placeholder='0' value='" + temp[i]['TotalQty'] + "' onchange='KeyNewTotalQty(\"" + temp[i]['RowID'] + "\",\"" + i + "\" ,\"" + temp[i]['ItemCode'] + "\" ,\"" + temp['ScTime'] + "\" )'>";
            ...
            }  else if ((temp["form"] == 'ShowDetailNew1st')) {
              $("#TableItemDetail tbody").empty();
              var isStatus = $("#IsStatus").val();
              var st1 = "style='font-size:24px;margin-left:20px; width:130px;'";
              for (var i = 0; i < temp["Row"]; i++) {
                var rowCount = $('#TableItemDetail >tbody >tr').length;
                var Sc = "<div class='row' style='margin-left:2px;'><button class='btn btn_mhee inputDis' style='height:40px;width:32px;' onclick='DelTotalQty1st(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\",\"" + temp[i]['ItemCode'] + "\",\"" + temp['ScTime'] + "\")'>-</button>" +
                  "<input name='Sc_save' autocomplete='off' class='form-control numonly QtyItem inputDis' style='height:40px;width:60px; margin-left:3px; margin-right:3px; text-align:center;' id='qty1_" + i + "' value='" + temp[i]['CcQty'] + "' onchange='KeyNewCcQty1st(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\" ,\"" + temp[i]['ItemCode'] + "\" ,\"" + temp['ScTime'] + "\")'>" +
                  "<button class='btn btn_mheesave inputDis' style='height:40px;width:32px;' onclick='addTotalQty1st(\"" + temp[i]['RowID'] + "\",\"" + i + "\",\"" + temp[i]['ParQty'] + "\",\"" + temp[i]['ItemCode'] + "\",\"" + temp['ScTime'] + "\")'>+</button></div>";
                var Order = "<input autocomplete='off' class='form-control numonly' id='order" + i + "' type='text' style='text-align:center;font-size: 24px!important'>";

                var Par = "<input autocomplete='off' class='form-control' id='Par_" + i + "' type='text' style='text-align:center;font-size: 24px!important' disabled value='" + temp[i]['ParQty'] + "'>";

                var Issue = "<input name='Issue_save' autocomplete='off' class='form-control decimal numonly inputDis' id='Issue_" + i + "'  type='text' style='text-align:center;font-size: 24px!important' placeholder='0' value='" + temp[i]['TotalQty'] + "' onchange='KeyNewTotalQty1st(\"" + temp[i]['RowID'] + "\",\"" + i + "\" ,\"" + temp[i]['ItemCode'] + "\" ,\"" + temp['ScTime'] + "\" )'>";
                  ...
                  <div class="container-fluid">
                    <div class="card-body mt-3">
                      <div class="row">
                        <div class="col-md-6">
                          <div class='form-group row'>
                            ...
                            <select class="form-control col-sm-7 icon_select checkblank4" style="font-size:22px;" id="hotpital" onchange="getDepartment('tab1');" <?php if ($PmID == 2 || $PmID == 3 || $PmID == 4 || $PmID == 5 || $PmID == 7) echo 'disabled="true" '; ?>></select>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class='form-group row'>
                            <label class="col-sm-4 col-form-label " style="font-size:24px;"><?php echo $array['phone'][$language]; ?></label>
                            <input type="text" autocomplete="off" id="txtPhoneNumber" disabled="true" style="font-size:22px;" class="form-control col-sm-7 " name="searchitem" placeholder="<?php echo $array['phone'][$language]; ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class='form-group row'>
                            <label class="col-sm-4 col-form-label " style="font-size:24px;"><?php echo $array['remask'][$language]; ?></label>
                            <input type="text" autocomplete="off" id="txtRemark" style="font-size:22px;" class="form-control col-sm-7 " name="searchitem" placeholder="<?php echo $array['remask'][$language]; ?>">
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row mt-3">
                <div class="col-md-2">
                  <div class="row" style="font-size:24px;margin-left:2px;">
                    <select onchange="getDepartment('tab2');" class="form-control" style='font-size:24px;' id="side">
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
              ...
              <div class="search_custom col-md-2">
                <div class="import_1 d-flex justify-content-start opacity" id="bSaveadd2">
                  <button class="btn dis" onclick="getImport()" id="bSaveadd" disabled="true">
            ...
            <table class="table table-fixed table-condensed table-striped" id="TableItem" width="100%" cellspacing="0" role="grid" style="font-size:24px;width:1100px">
              <thead style="font-size:24px">
                <tr role="row">
                  ...
                  <th style='width: 64%;' nowrap><?php echo $array['no'][$language]; ?></th>
