...
if (e.keyCode == 13) {
  ...
  function OpenDialogItem(){
    ...
    function dis2(row){
      ...
      if(docno!=""&&docno!=undefined){
        var url  = "../report/Report_damagenh_tc.php?DocNo="+docno+"&lang="+lang+"&HptCode="+HptCode;
        window.open(url);
      }else{
        swal({
          title: '',
  ...
  <body id="page-top">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><?php echo $array2['menu']['general']['sub'][15][$language]; ?></li>
    </ol>
            ...
            <div class="row">
              <div class="col-md-12" style='padding-left: 26px;' id='switch_col'>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab"  data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><?php echo $array['titledamage2'][$language]; ?></a>
                  </li>
                  <li class="nav-item">
