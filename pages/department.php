                            ...
                            <div class="row" <?php if ($PmID != 1 && $PmID != 6) echo 'hidden'; ?>>
                                <div class="col-md-6">
                                    <div class='form-group row'>
                                        ...
                                        <input type="text" autocomplete="off" onkeyup="resetinput()" maxlength="11" class="form-control col-sm-7 checkblankpm" id="shipto" placeholder="SHIP_TO">
